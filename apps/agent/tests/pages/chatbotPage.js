...
class ChatbotPage {
    constructor(page) {
      ...
      this.btn_send = this.page.locator('[d="M6 15.351V1.693m0 0L1.122 6.815M6 1.693l4.878 5.122"]');
    ...
    async importFiles(files) {
        ...
        try {
            ...
            const fileInputs = await this.page.locator('input[accept*="pdf"], input[accept*="document"], input[type="file"]').all();
